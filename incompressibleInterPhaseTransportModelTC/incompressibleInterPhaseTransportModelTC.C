...
Foam::incompressibleInterPhaseTransportModelTC::
incompressibleInterPhaseTransportModelTC
(
...
Foam::incompressibleInterPhaseTransportModelTC::divDevTau
(
...
) const
{
    ...
    {
        return
          mixture_.thermo1().rho()*turbulence1_->divDevSigma(U)
        + mixture_.thermo2().rho()*turbulence2_->divDevSigma(U);
    }
    else
    {
...
void Foam::incompressibleInterPhaseTransportModelTC::predict()
{
    if (twoPhaseTransport_)
    {
...
void Foam::incompressibleInterPhaseTransportModelTC::correct()
{
    if (twoPhaseTransport_)
    {
